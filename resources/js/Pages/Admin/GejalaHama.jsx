...
import GejalaForm from "../../Components/GejalaHama/GejalaForm";
import GejalaTable from "../../Components/GejalaHama/GejalaTable";

export default function Gejalas(props) {
    const [showModal, setShowModal] = useRecoilState(modalToggle);
    const [dataEdit, setDataEdit] = useRecoilState(modalData);
    const GejalasData = props.gejalahama.data; 

    return (
        <Admin judul="Gejala Hama">
            <GejalaForm />
            <div className="p-4 space-y-3">
                ...
                <GejalaTable gejalasData={GejalasData} />
            </div>
        </Admin>
    );
}
