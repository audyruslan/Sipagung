...
import KondisiForm from "../../Components/KondisiHama/KondisiForm";
import KondisiTable from "../../Components/KondisiHama/KondisiTable";

export default function KondisiHamas(props) {
    const [showModal, setShowModal] = useRecoilState(modalToggle);
    const [dataEdit, setDataEdit] = useRecoilState(modalData);
    const KondisisData = props.kondisihama.data; 

    return (
        <Admin judul="Kondisi Hama">
            <KondisiForm />
