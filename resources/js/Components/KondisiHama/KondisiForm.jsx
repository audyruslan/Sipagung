...
export default function KondisiForm() {
    ...
    const submitKondisi = (e) => {
        ...
        if (editData) {
            Inertia.post("kondisihama-update", kondisiData, {
                onError: (e) => {
                ...
                onSuccess: () => {
                    ...
                    toast.success("Kondisi Hama berhasil diubah!");
                },
            });
        } else {
            Inertia.post("kondisihama", kondisiData, {
                onError: (e) => {
                    setError(e);
                },
                onSuccess: () => {
                    ...
                    toast.success("Kondisi Hama berhasil ditambahkan!");
                },
            });
        }
    };
            ...
            <ModalRoot
                title={
                    <h1 className="font-semibold text-gray-800 text-xl">
                        {`${editData ? "Edit" : "Tambah"} Kondisi Hama`}
                    </h1>
                }
            >
                <form
                ...
                >
                    <div className="flex flex-col space-y-1">
                        <h1 className="text-gray-500 text-sm">Kondisi Hama</h1>
                        <input
                            onChange={(e) => {
                                setKondisiData((kondisiData) => ({
                                    ...kondisiData,
